              ...
              <div class="box-body table-responsive no-padding">
                <table class="table table-hover">
                  <tr>
                    ...
                    @foreach ($outPersonalDetails as $p_detail)
                      <tr>
                        <td>{{ $p_detail->id }}</td>

                        <td>
                         {{$p_detail->outApplicantDetails->host_univ}}
                        </td>
                        ...
                        <td>
                          <form method="get" action="{{ route('admin.outDetail', ['outPersonalDetails' => $p_detail->id]) }}">
                            <button type="submit" class="btn btn-success btn-sm">Detail</button>
                          </form>
                        </td>

                        <td>
                          <form method="get" action="{{ route('out.pdf', ['id' => $p_detail->id]) }}">
